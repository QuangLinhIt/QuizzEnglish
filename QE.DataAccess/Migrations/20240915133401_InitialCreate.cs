        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LimitTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Competitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Competitions_AspNetUsers_Player1Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizzStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VocabularyTopics", x => new { x.VocabularyId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_VocabularyTopics_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionQuizzes", x => new { x.CompetitionId, x.QuizzId });
                    table.ForeignKey(
                        name: "FK_CompetitionQuizzes_Competitions_CompetitionId",
                        column: x => x.CompetitionId,
                        principalTable: "Competitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompetitionQuizzes_Quizzes_QuizzId",
                        column: x => x.QuizzId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizzScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuizzScores_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_QuizzScores_Quizzes_QuizzId",
                        column: x => x.QuizzId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionQuizzes_QuizzId",
                table: "CompetitionQuizzes",
                column: "QuizzId");

            migrationBuilder.CreateIndex(
                name: "IX_Competitions_Player1Id",
                table: "Competitions",
                column: "Player1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Competitions_Player2Id",
                table: "Competitions",
                column: "Player2Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizzScores_AppUserId",
                table: "QuizzScores",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_QuizzScores_QuizzId",
                table: "QuizzScores",
                column: "QuizzId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VocabularyTopics_TopicId",
